...
def openTEPES_run(DirName, CaseName, SolverName, pIndOutputResults, pIndLogConsole, formulation_index, dead_zone):
    ...
    #%% model declaration
    mTEPES = ConcreteModel('Open Generation, Storage, and Transmission Operation and Expansion Planning Model with RES and ESS (openTEPES) - Version 4.17.3 - June 19, 2024')
    print(                 'Open Generation, Storage, and Transmission Operation and Expansion Planning Model with RES and ESS (openTEPES) - Version 4.17.3 - June 19, 2024', file=open(_path+'/openTEPES_version_'+CaseName+'.log','w'))
