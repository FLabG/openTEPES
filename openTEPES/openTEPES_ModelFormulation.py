...
def GenerationOperationModelFormulationStorage(OptModel, mTEPES, pIndLogConsole, p, sc, st):
    ...
    def eESSInventory(OptModel,n,es):
        if (p,es) in mTEPES.pes:
            if   (p,sc,st,n) in mTEPES.s2n and mTEPES.Period[p].Scenario[sc].Stage[st].n.ord(n) == mTEPES.Period[p].Scenario[sc].Stage[st].pStorageTimeStep[es]:
                if es not in mTEPES.ec:
                    return mTEPES.pIniInventory[p,sc,n,es]()                                            + sum(mTEPES.pDuration[p,sc,n2]()*(mTEPES.pEnergyInflows[p,sc,n2,es]() - OptModel.vEnergyOutflows[p,sc,n2,es] - OptModel.vTotalOutput[p,sc,n2,es] + mTEPES.pEfficiency[es]*OptModel.vESSTotalCharge[p,sc,n2,es]) for n2 in list(mTEPES.Period[p].Scenario[sc].Stage[st].n2)[mTEPES.Period[p].Scenario[sc].Stage[st].n.ord(n)-mTEPES.Period[p].Scenario[sc].Stage[st].pStorageTimeStep[es]:mTEPES.Period[p].Scenario[sc].Stage[st].n.ord(n)]) == OptModel.vESSInventory[p,sc,n,es] + OptModel.vESSSpillage[p,sc,n,es]
                else:
            ...
            elif (p,sc,st,n) in mTEPES.s2n and mTEPES.Period[p].Scenario[sc].Stage[st].n.ord(n) >  mTEPES.Period[p].Scenario[sc].Stage[st].pStorageTimeStep[es]:
                if es not in mTEPES.ec:
                    return OptModel.vESSInventory[p,sc,mTEPES.Period[p].Scenario[sc].Stage[st].n.prev(n,mTEPES.Period[p].Scenario[sc].Stage[st].pStorageTimeStep[es]),es] + sum(mTEPES.pDuration[p,sc,n2]()*(mTEPES.pEnergyInflows[p,sc,n2,es]() - OptModel.vEnergyOutflows[p,sc,n2,es] - OptModel.vTotalOutput[p,sc,n2,es] + mTEPES.pEfficiency[es]*OptModel.vESSTotalCharge[p,sc,n2,es]) for n2 in list(mTEPES.Period[p].Scenario[sc].Stage[st].n2)[mTEPES.Period[p].Scenario[sc].Stage[st].n.ord(n)-mTEPES.Period[p].Scenario[sc].Stage[st].pStorageTimeStep[es]:mTEPES.Period[p].Scenario[sc].Stage[st].n.ord(n)]) == OptModel.vESSInventory[p,sc,n,es] + OptModel.vESSSpillage[p,sc,n,es]
                else:
                    return OptModel.vESSInventory[p,sc,mTEPES.Period[p].Scenario[sc].Stage[st].n.prev(n,mTEPES.Period[p].Scenario[sc].Stage[st].pStorageTimeStep[es]),es] + sum(mTEPES.pDuration[p,sc,n2]()*(OptModel.vEnergyInflows[p,sc,n2,es] - OptModel.vEnergyOutflows[p,sc,n2,es] - OptModel.vTotalOutput[p,sc,n2,es] + mTEPES.pEfficiency[es]*OptModel.vESSTotalCharge[p,sc,n2,es]) for n2 in list(mTEPES.Period[p].Scenario[sc].Stage[st].n2)[mTEPES.Period[p].Scenario[sc].Stage[st].n.ord(n)-mTEPES.Period[p].Scenario[sc].Stage[st].pStorageTimeStep[es]:mTEPES.Period[p].Scenario[sc].Stage[st].n.ord(n)]) == OptModel.vESSInventory[p,sc,n,es] + OptModel.vESSSpillage[p,sc,n,es]
            else:
                return Constraint.Skip
